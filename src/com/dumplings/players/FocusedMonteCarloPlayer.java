...
import com.dumplings.heuristics.FocusedMonteCarlo;
import com.dumplings.strategies.AlphaBeta;

/**
 * AlphaBetaPlayer plays by using alpha-beta-pruning
 */
public final class FocusedMonteCarloPlayer extends StateMachineGamer
{
	...
	public String getName() {
		return "Focused Monte Carlo Dumplings";
	}
